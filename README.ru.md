...
**v0.3 — alpha.** Основная идея подтверждена от начала до конца полным набором
тестов (119 офлайн-тестов) и зелёным CI. v0.3 добавляет скачиваемую десктоп-
оболочку; v0.2 добавил стриминг, параллельные инструменты и human-in-the-loop
